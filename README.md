...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=dremio.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.dremio.btnmi-chart.v0&gk_description=Helm%20chart%20for%20dremio%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=dremio.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **dremio** Helm chart, originally
